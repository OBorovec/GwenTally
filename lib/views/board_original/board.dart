...
import 'package:gwentboard/views/board_original/components/battle_side/battle_side.dart';
import 'package:gwentboard/views/board_original/components/battle_side/bloc/battle_side_bloc.dart';
import 'package:gwentboard/views/board_original/components/battle_side/battle_side_compact.dart';
import 'package:gwentboard/views/board_original/components/game/bloc/game_bloc.dart';
import 'package:gwentboard/views/board_original/components/game/game_control_state.dart';
import 'package:gwentboard/views/board_original/components/game/game_control_weather.dart';
import 'package:gwentboard/views/board_original/components/game/game_score.dart';
import 'package:gwentboard/views/board_original/components/pack/bloc/pack_bloc.dart';
import 'package:gwentboard/views/board_original/components/pack/pack_control.dart';
import 'package:gwentboard/views/board_original/components/pack/pack_wrap.dart';
      ...
      body: MultiBlocProvider(
        ...
        child: MultiRepositoryProvider(
          providers: [
            ...
            RepositoryProvider(
              create: (context) => BoardCardSize(cardVerticalSpace: 60),
            ),
          ],
